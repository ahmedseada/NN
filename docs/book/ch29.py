"""Chapter 29 — Anomaly Detection with Autoencoders."""
from gen import *
...
def build():
    return page(
        ...
        h2("29.3 Making it work on real data"),
        ...
        ], caption="Table 29.1 — Practical issues"),
