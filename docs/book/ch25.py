"""Chapter 25 — Testing, Gradient Checking and Debugging."""
from gen import *
...
def build():
    return page(
        ...
        h2("25.1 The library's own tests"),
        ...
        ], caption="Table 25.1 — What the suite tests"),
        h2("25.2 Testing your own layers"),
        snippet("""
        ...
        cpugpu("comparing devices",
               ...
               """),
        h2("25.3 When training goes wrong"),
        deriv("A procedure that finds most bugs", [
            ...
            "<b>Check gradients</b> of any custom layer or loss (Section 25.2).",
        ...
        reftable(["Symptom", "Likely causes", "Where to look"], [
            ...
            ["CPU and GPU differ a lot", "Different weights (seed, loading), or a device bug: report it with a minimal repro", "Section 25.2"],
        ], caption="Table 25.2 — Symptoms and causes"),
        mex("overfitting one tiny batch as a smoke test", None,
            ...
            """),
        h2("25.4 Tools for looking inside"),
        reftable(["Tool", "Shows"], [
        ...
        ], caption="Table 25.3 — Debugging tools"),
        practice([
            ...
            (2, "Run the gradient check of Section 25.2 on <code>Losses.BinaryCrossEntropyWithLogits</code> with fixed targets.",
