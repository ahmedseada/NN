"""Chapter 25 — Regression: Predicting House Prices."""
from gen import *
...
def build():
    return page(
        ...
        h2("25.1 The project at a glance"),
        ...
        ], caption="Table 25.1 — The pipeline and where each part is explained"),
        ...
        h2("25.3 The model and training"),
        snippet("""
        ...
        h2("25.6 Adapting it to your data"),
        ...
        ], caption="Table 25.2 — Common adaptations"),
