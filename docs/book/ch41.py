"""Chapter 41 — NeuralSharp in Every .NET Project Type."""
from gen import *
...
def build():
    return page(
        ...
        h2("41.1 The pattern: one library, many front ends"),
        ...
        ], caption="Table 41.1 — Project types covered, and what was verified for this book (Linux container)"),
        ...
        h2("41.6 Desktop: Windows Forms and WPF"),
        ...
        h2("41.7 Containers and the cloud"),
        snippet("""
        ...
        ], caption="Table 41.2 — Where the applications can run"),
